...
class Agent(object):
    ...
    def learn(self):
        if self.memory.mem_cntr < self.batch_size:
            return
        state, reward, action, new_state, done = self.memory.sample_buffer(self.batch_size)
        ...
        #print("critiv_value target", critic_value_)
        #print("critiv_value times done", critic_value*done)
